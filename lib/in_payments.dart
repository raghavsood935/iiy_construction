...
class INPayments extends StatefulWidget {

  @override
  State<INPayments> createState() => _INPaymentsState();
}

class _INPaymentsState extends State<INPayments> {
                    ...
                    child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                            ...
                            backgroundColor: MaterialStateProperty.all(Color(0xff117660))
                        ),
                        child: Center(
                          child: Text(
                              "SAVE"
